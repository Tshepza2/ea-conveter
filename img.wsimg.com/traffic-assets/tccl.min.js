!function(t, e) {
    ...
    var k = function(t, e) {
      ...
      , F = function() {
        return function(t) {
            ...
            if (e += "-" + A(t.getUTCDate()) + "T" + A(t.getUTCHours()) + ":",
            e += A(t.getUTCMinutes()) + ":" + A(t.getUTCSeconds()),
            t.getUTCMilliseconds) {
                var n = t.getUTCMilliseconds();
                M(n) && (e += "." + String((n / 1e3).toFixed(3)).slice(2, 5))
            }
            return e + "Z"
        }(new Date)
    }
    ...
    var $, W = {}, Q = {
        ...
        try {
            ($ = f().performance) && $.timing ? (function(t) {
                if (t.merge(Y($.timing)),
                $.getEntriesByName) {
                    var e = $.getEntriesByName(s().location.href)[0];
        ...
        return !($ = f().performance) || !$.timing || $.timing.loadEventStart > 0
    }, ot = !1;
    function it(t) {
    ...
    function At(t, e, n, r) {
        var o = Dt(Bt(1 & r ? t.prototype : t), e, n);
    ...
    function Dt() {
        return Dt = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(t, e, n) {
            var r = function(t, e) {
                for (; !{}.hasOwnProperty.call(t, e) && null !== (t = Bt(t)); )
                    ;
                return t
            }(t, e);
            if (r) {
    ...
    const qt = new (function(t) {
        function e(t) {
            ...
            (n = function(t, e, n) {
                ...
                }(t, Rt() ? Reflect.construct(e, n || [], Bt(t).constructor) : e.apply(t, n))
        ...
        build: {
            env: "prod",
            date: "2025-04-08T13:06:10.299Z"
        },
        client: {
            name: "scc-c2",
            version: "1.0.5",
            hash: "20c1399c053a941ef37a44b228afb4e759e8be04"
        },
        cookie: {
            sameSite: "none"
        },
    ...
    var Ht, $t, Wt = [], Qt = {}, Jt = 0, Zt = function(t) {
        ...
        var t, e, n = function() {
            for (var t = {}, e = 0; e < Nt.length; e++) {
                var n = Nt[e];
                k(n, (function(e, n) {
                    -1 === $t.indexOf(e.toLowerCase()) && (Xt(e, n),
                    Zt(e) || (t[e] = n))
                }
                ))
            }
        ...
        e = {
            ...
            timing: {
                auto: !D(t["".concat(Ut, ".manualPagePerf")], !1)
            },
            page: {
                spa: t["".concat(Ut, ".spa")],
            ...
            wGtm: {
                enabled: D(t["".concat(Ut, ".webGtmEnabled")], !1)
            },
            clickListener: {
                enabled: !D(t["".concat(Ut, ".listenerDisabled")], !1),
    ...
    var rn = ["_expDataLayer", "_signalsDataLayer"]
      ...
      , an = function(t) {
        function n(t) {
            ...
            e.beforeEvent = i,
            e.immediateSchemas = [on].concat(We(c)),
            e._initEvents(),
            e
        }
        return function(t, e) {
        ...
        (o = [{
            ...
            value: function() {
                for (var t = !this.autoPageViewDisabled, e = this.asyncCommands.length - 1; e >= 0; e--) {
                    ...
                    "set_config" === n.schema && this.process.apply(this, We(this.asyncCommands.splice(e, 1)))
                }
                t && this.process({
                ...
                try {
                    ...
                    function() {
                        for (; Jt < Nt.length; ) {
                            var t = Nt[Jt];
                            k(t, (function(t, e) {
                                -1 === $t.indexOf(t.toLowerCase()) && Zt(t) && (Xt(t, e),
                                Qt[t] = e)
                            }
                            )),
                            Jt++
    ...
    function Cn(t, e) {
        return function(t) {
            ...
            if (t) {
                ...
                var n = {}.toString.call(t).slice(8, -1);
                return "Object" === n && t.constructor && (n = t.constructor.name),
                "Map" === n || "Set" === n ? Array.from(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? In(t, e) : void 0
            }
        }(t, e) || function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
        }()
        ...
        (e = [{
            ...
            value: function(t) {
                ...
                return Object.entries(t).forEach((function(t) {
                    var n, r = Cn(t, 2), o = r[0], i = r[1], a = o.split("."), c = e;
    ...
    var tr = {}
      ...
      , rr = function(t, e, n) {
        ...
        o.events.length > 0 && nr(t, e, o)) : n.events.forEach((function(n) {
            r && !r.includes(n.schemaId) || nr(t, e, T(o, {
                event: n
            }))
        }
        ))
      ...
      , or = function(t, e) {
        var n = cr();
        n.length >= ir && g("".concat(t, " subscribed to SCC after the eventQueue was full. Some events may have been lost.")),
      ...
      , ur = "urn:shared:user:event:/data-platform/signals/click/v1"
      , fr = "urn:shared:user:event:/data-platform/signals/impression/v1"
      , sr = "urn:shared:user:event:/data-platform/signals/element-action/v1"
      , lr = "urn:shared:user:event:/data-platform/signals/traffic-event/v1"
      , pr = "urn:shared:user:event:/data-platform/signals/page-view/v1"
      , yr = "urn:shared:user:event:/data-platform/signals/ecommerce/add-to-cart/v1"
      , vr = "urn:shared:user:event:/data-platform/signals/ecommerce/checkout-progress/v1"
      , br = "urn:shared:user:event:/data-platform/signals/ecommerce/remove-from-cart/v1"
      , dr = "urn:shared:user:event:/data-platform/signals/ecommerce/transaction/v2"
      , mr = "urn:shared:user:event:/data-platform/signals/ecommerce/planned-purchase/v1"
      , hr = "urn:shared:user:event:/data-platform/signals/experiment-assignment/v1"
      , gr = "urn:shared:user:event:/rigor/page-navigation/v1"
      , wr = "urn:shared:user:event:/rigor/page-navigation-delayed/v1"
      , Or = "urn:shared:user:event:/data-platform/signals/conversion/v1"
      , jr = "urn:shared:user:event:/appconfig/id-percentage-evaluation/v1"
      , _r = function(t) {
        var e, n, r = t.globalSchemaId, o = t.businessContext, i = t.events, a = t.webContext, c = t.routing, u = void 0 === c ? {} : c, f = u.eventBusApiKey, s = u.hasConversion, l = u.targets;
        if (q(i) && 0 !== i.length) {
            for (var p, y = F(), v = 0; v < i.length; v++)
                i[v].data = T({
                    eventCreationTimestamp: y
                }, i[v].data);
            Wn.updateContext(),
            Zn.updateContext(),
            n = {
                schemaId: r || (p = null === (e = Wn.context.site) || void 0 === e ? void 0 : e.privateLabelId,
                p ? "urn:shared:user:events:/v2" : "urn:shared:user:events:/v1"),
                global: Wn.context,
                businessContext: o,
                events: i,
                webContext: T(Zn.context, a),
                routing: {
                    eventBusApiKey: f || bt("eventBus", "sccApiKey"),
                    globalContextVersion: Wn.version,
                    hasConversion: s,
                    targets: l
                }
            },
            ...
            ar.push(n),
            function(t) {
                for (var e = 0, n = Object.entries(tr); e < n.length; e++) {
                    var r = (c = 2,
                    function(t) {
                        if (Array.isArray(t))
                            return t
    ...
    function Pr(t, e) {
        for (var n = 0; n < e.length; n++) {
            ...
            r.configurable = !0,
            "value"in r && (r.writable = !0),
            Object.defineProperty(t, Er(r.key), r)
        }
    }
    function Er(t) {
        var e = function(t) {
    ...
    var Ir = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, kr() ? Reflect.construct(e, n || [], Tr(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
    ...
    const Mr = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, Ar() ? Reflect.construct(e, n || [], Dr(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
    ...
    var Fr = /[^a-z0-9\_\/\.\-]/g
      , qr = /^([a-z0-9_\-]+)\.([a-z0-9_\-]+)\.(([a-z0-9_\/\-]+)\.)?([a-z0-9_\/\-]+)\.([a-z0-9_\-]+)\.([a-z0-9_\-]+)$/g
      , Ur = function() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
          , e = t.eid
      ...
      , Nr = function(t, e, n, r) {
        ...
        if (e) {
            ...
            (function(t) {
                return !!(t.match(qr) && t.length <= 500)
            }
            )(e) && function(t, e, n) {
      ...
      , Kr = function(t, e, n, r) {
        var o = Y(e);
        !function(t, e) {
            Vr(t, "pageLoadTime", e.loadEventStart, e.navigationStart),
            Vr(t, "domContentLoadedTime", e.domContentLoadedEventStart, e.navigationStart),
            Vr(t, "domInteractiveTime", e.domInteractive, e.navigationStart),
            Vr(t, "pageDownloadTime", e.responseEnd, e.responseStart),
            Vr(t, "domainLookupTime", e.domainLookupEnd, e.domainLookupStart),
            Vr(t, "serverResponseTime", e.responseStart, e.requestStart),
            Vr(t, "serverConnectionTime", e.connectEnd, e.connectStart),
            Vr(t, "redirectionTime", e.fetchStart, e.navigationStart)
        }(o, e);
        var i = {
    ...
    const Zr = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, Wr() ? Reflect.construct(e, n || [], Qr(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
    ...
    const oo = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, eo() ? Reflect.construct(e, n || [], no(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
    ...
    function so() {
        return so = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(t, e, n) {
            var r = function(t, e) {
                for (; !{}.hasOwnProperty.call(t, e) && null !== (t = lo(t)); )
                    ;
                return t
            }(t, e);
            if (r) {
    ...
    const yo = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, fo() ? Reflect.construct(e, n || [], lo(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
        ...
        r = [{
            ...
            value: function(t) {
                ...
                return t.impressions.forEach((function(t) {
                    ...
                    r.push.apply(r, function(t) {
                        return function(t) {
                            ...
                            if (t) {
                                ...
                                var n = {}.toString.call(t).slice(8, -1);
                                return "Object" === n && t.constructor && (n = t.constructor.name),
                                "Map" === n || "Set" === n ? Array.from(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? ao(t, e) : void 0
                            }
                        }(t) || function() {
                            throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                        }()
                    ...
                    i = n,
                    "function" == typeof (a = so(lo(1 & 3 ? o.prototype : o), "_getEvents", i)) ? function(t) {
                        return a.apply(i, t)
                    }
                    : a)([t, ae()])))
                }
    ...
    var Oo = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, ho() ? Reflect.construct(e, n || [], go(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
        ...
        (r = [{
            ...
            value: function(t) {
                ...
                k(t.config, (function(e, n) {
                    if (!t.overwrite) {
                        var r = qt.get(e);
                        q(r) ? n = [].concat(r, n) : "object" === vo(r) && (n = T(r, n))
                    }
                    qt.set(e, n)
                }
                ))
    ...
    function ko(t, e) {
        return ko = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t, e) {
            return t.__proto__ = e,
            t
        }
        ,
    ...
    function Ro(t, e, n, r) {
        var o = Ao(Do(1 & r ? t.prototype : t), e, n);
        return 2 & r && "function" == typeof o ? function(t) {
            return o.apply(n, t)
        }
        : o
    ...
    function Ao() {
        return Ao = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(t, e, n) {
            var r = function(t, e) {
    ...
    function Bo(t, e) {
        return Bo = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t, e) {
            return t.__proto__ = e,
            t
        }
        ,
    ...
    var Mo, Fo, qo = function(t) {
        ...
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, Lo() ? Reflect.construct(e, n || [], Do(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
        ...
        (r = [{
            ...
            key: "set",
            value: function(t, n) {
                "object" !== Co(n) && "[object Function]" !== {}.toString.call(n) ? Ro(e, "set", this, 3)([t, n]) : h("Invalid key/value pair found in Traffic's custom properties (tData). Objects, arrays, and functions are not supported.\n\nKey: '".concat(t, "' Value: '").concat(n, "' Type: '").concat(Co(n), "'."))
            }
        }]) && Io(n.prototype, r),
        Object.defineProperty(n, "prototype", {
            writable: !1
    ...
    function Qo(t) {
        return Qo = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(t) {
            return t.__proto__ || Object.getPrototypeOf(t)
        }
        ,
        Qo(t)
    ...
    var Zo = 0
      ...
      , Yo = function(t) {
        function e() {
            ...
            function(t, e, n) {
                return e = Qo(e),
                function(t, e) {
                    if (e && ("object" == zo(e) || "function" == typeof e))
                        return e;
                    if (void 0 !== e)
                        throw new TypeError("Derived constructors may only return object or undefined");
                    return function(t) {
                ...
                }(t, Wo() ? Reflect.construct(e, n || [], Qo(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
        ...
        (r = [{
            ...
            value: function(t) {
                ...
                return [{
                    ...
                    data: {
                        forensics: {
                            traceIdAdopted: D(dn.get("traced")),
                            components: Xo()
                        },
                        traffic: Ur({
      ...
      , ni = function() {
        return [(new ze).substitute(ei([new Ke("eid")]))]
    }
      , ri = function() {
        return [(new ze).substitute(ti()), (new ze).substitute(ni()), (new ze).map("promotion", [new Ke("id").required(), new Ke("name"), new Ke("creative"), new Ke("position")]), (new ze).map("product", [new Ke("actionCode").required().allowedValues(["add_to_cart", "product_detail"]), (new ze).map("basket", [new Ke("couponCode"), new Ke("currencyCode"), new Ke("itemTrackingCode")]), (new He).map("products", [new Ke("productId").required(), new Ke("productName"), new Ke("productInstanceId"), new Ke("priceUsd"), new Ke("quantity").required(), new Ke("couponCode"), new Ke("itemTrackingCode")]), (new He).map("packages", [new Ke("id"), new Ke("priceUsd"), new Ke("quantity"), new Ke("category")])])]
    };
    const oi = {
        add_click: {
            v1: {
                handler: oo,
                properties: [(new ze).substitute(ri()).transform(Ko)]
            }
        },
        add_element_action: {
            v1: {
                handler: Zr,
                properties: [(new ze).substitute([(new ze).substitute(ti([new Ke("action").required().allowedValues(["blur", "drag", "focus", "hover", "load", "scroll"])])), (new ze).substitute(ni())]).transform(Ko)]
            }
        },
        add_impressions: {
            v1: {
                handler: yo,
                properties: [(new He).map("impressions", [(new ze).substitute(ri()).transform(Ko)]).withMinElements(1)]
            }
        },
        add_virtual_page_view: {
            v1: {
                handler: Yo,
                properties: [new Ke("virtualPath").required(), (new ze).substitute(ei())]
            }
        },
        add_micro_events: {
            v1: {
    ...
    or("scc-experiment-listener", {
        callback: function(t) {
            var e = t.event
              , n = e.data;
            if (e.schemaId === hr)
                fi(n.experimentId, n.variantId);
            else if (e.schemaId === jr && "hivemind" === n.fqAppId) {
                var r = JSON.parse(n.settingValue);
                fi(n.setting, r.cohortId)
            }
        },
        schemaIds: [hr, jr]
    });
            ...
            function() {
                ...
                if (t.PerformanceObserver) {
                    var e = new t.PerformanceObserver((function(t) {
                        var e = t.getEntries()
                          , n = e[e.length - 1];
                        n.renderTime && (W.lcp = Math.round(n.startTime))
                    }
                    ));
                    try {
                        e.observe({
      ...
      , ki = function(t) {
        function e() {
            ...
            return t = function(t, e, n) {
                return e = ji(e),
                function(t, e) {
                    if (e && ("object" == gi(e) || "function" == typeof e))
                        return e;
                    if (void 0 !== e)
                        throw new TypeError("Derived constructors may only return object or undefined");
                    return function(t) {
                ...
                }(t, Oi() ? Reflect.construct(e, n || [], ji(t).constructor) : e.apply(t, n))
            }(this, e, [].concat(a)),
            n = t,
            o = "_scc_session",
            (r = Si(r = "_sessionCookieName"))in n ? Object.defineProperty(n, r, {
                value: o,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        return t = function t() {
            ...
            e = this,
            r = void 0,
            (n = hi(n = "_sessionCookieName"))in e ? Object.defineProperty(e, n, {
                value: r,
                enumerable: !0,
                configurable: !0,
                writable: !0
    ...
    var Ai = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, xi() ? Reflect.construct(e, n || [], Li(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
        ...
        (r = [{
            ...
            value: function(t) {
                var e = t.eid
                  ...
                  , r = function(t) {
                    return "click" === t ? ur : "impression" === t ? fr : ["blur", "drag", "focus", "hover", "load", "scroll"].includes(t) ? sr : lr
                }(n)
                  , o = Vo(t).getProperties();
                return [{
                    schemaId: r,
                    data: r !== lr ? Nr(this.internal.eventId, e, n, o) : {
                        traffic: Ur({
                            customProperties: o,
                            eid: e,
                            eventCategory: n
    ...
    var Ni = function(t) {
        function e() {
            ...
            function(t, e, n) {
                ...
                }(t, Fi() ? Reflect.construct(e, n || [], qi(t).constructor) : e.apply(t, n))
            }(this, e, arguments)
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e)
            ...
            value: function(t) {
                ...
                if (n) {
                    if (n.navigationStart)
                        return [{
                            schemaId: gr,
                            data: Kr(this.internal.eventId, n, t.custom_properties, e)
                        }];
                    if (n.timeToInteractive)
                        return [{
                            schemaId: wr,
                            data: Gr(this.internal.eventId, n, t.custom_properties)
                        }]
                }
            }
        }]) && Bi(n.prototype, r),
    ...
    const Ki = {
        add_event: {
            v1: {
                handler: Ai,
                properties: [new Ke("type").required(), (new ze).substitute([new Ke("eid").optional()]), (new ze).substitute(Vi())]
            }
        },
        add_page_view: {
            v1: {
                handler: Yo,
                properties: [new Ke("path").optional(), (new ze).substitute(Vi())]
            }
        },
        add_perf: {
            v1: {
                handler: Ni,
                properties: [new Ke("timing_object").required(), new Ke("is_hard_navigation").optional(), (new ze).substitute(Vi())]
            }
        }
    }
      , Gi = function(t, e, n) {
      ...
      , zi = function(t, e) {
        f()._expDataLayer.push({
            ...
            data: {
                timing_object: t,
                custom_properties: qo(e)
            }
        })
    };
    var Hi = "traffic.tcc.instrumentation.navigation.timing"
      , $i = "click"
      , Wi = "impression"
      , Qi = function(t, e) {
        var n = e.data
      ...
      , Zi = function(t) {
        ...
        case mr:
            return "gpd.exp.tcc.planned-purchase.success";
        case hr:
    ...
    var ra, oa = "_trfqSendLog", ia = [pr, ur, fr, lr, sr, wr, gr], aa = function(t) {
        var e = t.events
          , n = t.global
          , r = t.webContext
          , o = function(t) {
        ...
        e.forEach((function(t) {
            ...
            !function(t, e) {
                ...
                k(t, (function(t, e) {
                    void 0 !== e && "object" !== na(e) && "[object Function]" !== {}.toString.call(e) && (r[t] = e)
                }
                )),
                n = {},
                k(r, (function(t, e) {
    ...
    function(t) {
                ...
                function() {
                    ...
                    !/msie [1-8]\./.test(a))
                        ...
                        "off" !== qt.get("".concat(e, ".status"))) {
                            var o = s();
                            "prerender" !== o.visibilityState ? bi(t) : o.addEventListener("visibilitychange", (function() {
                                "prerender" !== o.visibilityState && "unloaded" !== o.visibilityState && bi(t)
                            }
                            ))
                        }
                    var i, a
        ...
        hooks: {
            getEnvironment: function() {
                var t = qt.get("".concat(fa, ".baseHost"));
                if (t)
