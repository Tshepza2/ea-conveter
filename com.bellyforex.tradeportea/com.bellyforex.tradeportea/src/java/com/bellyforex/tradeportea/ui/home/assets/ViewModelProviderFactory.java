...
public final class ViewModelProviderFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(Class<T> cls) {
        ...
        return new AssetsViewModel(this.rtRepository);
    }
}
