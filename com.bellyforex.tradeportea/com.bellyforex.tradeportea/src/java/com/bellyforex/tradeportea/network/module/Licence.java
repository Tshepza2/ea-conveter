...
public final class Licence implements Serializable {
    ...
    public final Licence copy(String str, String str2, String str3, String str4, Owner owner, String str5, String str6, String str7, boolean z) {
        ...
        return new Licence(str, str2, str3, str4, owner, str5, str6, str7, z);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Licence) {
            ...
            return Intrinsics.areEqual(this.ea_name, licence.ea_name) && Intrinsics.areEqual(this.ea_notification, licence.ea_notification) && Intrinsics.areEqual(this.expires, licence.expires) && Intrinsics.areEqual(this.key, licence.key) && Intrinsics.areEqual(this.owner, licence.owner) && Intrinsics.areEqual(this.phone_secret_key, licence.phone_secret_key) && Intrinsics.areEqual(this.status, licence.status) && Intrinsics.areEqual(this.user, licence.user) && this.selected == licence.selected;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "Licence(ea_name=" + str + ", ea_notification=" + str2 + ", expires=" + str3 + ", key=" + str4 + ", owner=" + owner + ", phone_secret_key=" + str5 + ", status=" + str6 + ", user=" + str7 + ", selected=" + this.selected + ")";
    }

    public Licence(String str, String str2, String str3, String str4, Owner owner, String str5, String str6, String str7, boolean z) {
        Intrinsics.checkNotNullParameter(str, "ea_name");
        Intrinsics.checkNotNullParameter(str2, "ea_notification");
        Intrinsics.checkNotNullParameter(str3, "expires");
        Intrinsics.checkNotNullParameter(str4, "key");
    ...
    public /* synthetic */ Licence(String str, String str2, String str3, String str4, Owner owner, String str5, String str6, String str7, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
